...
async def signup(
    ...
    if existing_user:
        # request-otp auto-creates a password-less "stub" user the moment
        # someone verifies their email, before signup completes. If that's
        # all this record is, finish setting it up here rather than
        # rejecting a legitimate signup as a duplicate.
