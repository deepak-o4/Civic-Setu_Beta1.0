...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        if self._pageNumber > 1:
            ...
            self.drawString(36, letter[1] - 30, "CIVICSETU — URBAN INFRASTRUCTURE GRIEVANCE MONITORING SYSTEM")
        ...
        self.drawString(36, 30, "Report generated automatically. CivicSetu Grievance Redressal Monitoring System.")
...
class PDFReportGenerator:
    ...
    def generate_report(cls, complaints: List[Complaint], report_type: str, filter_desc: str) -> bytes:
        ...
        story.append(Paragraph("MUNICIPAL AUTHORITY", title_style))
        story.append(Paragraph("CIVICSETU URBAN INFRASTRUCTURE INTELLIGENCE PLATFORM — MONITORING SYSTEM", subtitle_style))
