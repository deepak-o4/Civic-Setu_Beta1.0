...
async def async_send_otp_email(email_to: str, otp: str) -> None:
    ...
    """
    subject = "CivicSetu Municipal Portal - OTP Verification Code"
    html_content = f"""
    <html>
        <body style="font-family: Arial, sans-serif; padding: 20px; line-height: 1.6;">
            <h2 style="color: #0b3c5d;">CivicSetu Urban Infrastructure Intelligence Platform</h2>
            <p>Hello,</p>
            <p>You requested a verification code to log in to the Municipal Authority Grievance Portal.</p>
            ...
            <p style="font-size: 12px; color: #999; text-align: center;">Municipal Authority &copy; 2026</p>
        </body>
    </html>
    """
...
async def async_send_complaint_acknowledgement_email(
    ...
    <html>
        <body style="font-family: Arial, sans-serif; padding: 20px; line-height: 1.6;">
            <h2 style="color: #0b3c5d;">Municipal Commissioner Desk</h2>
            <h3 style="color: #5cb85c;">Grievance Registration Acknowledgement</h3>
            <p>Dear {citizen_name},</p>
            <p>Thank you for reaching out to the Municipal Commissioner Desk. Your grievance has been registered successfully.</p>
...
async def async_send_notification_email(
    ...
    <html>
        <body style="font-family: Arial, sans-serif; padding: 20px; line-height: 1.6;">
            <h2 style="color: #0b3c5d;">CivicSetu Municipal Portal</h2>
        ...
        <body style="font-family: Arial, sans-serif; padding: 20px; line-height: 1.6; color: #333;">
            <div style="max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                <div style="background-color: #0b3c5d; color: #fff; padding: 20px; text-align: center;">
                    <h2 style="margin: 0; font-size: 20px; font-weight: bold; letter-spacing: 1px;">MUNICIPAL COMMISSIONER DESK</h2>
                ...
                <div style="background-color: #f5f7fa; padding: 15px; text-align: center; border-top: 1px solid #eee; font-size: 12px; color: #777;">
                    ...
                    <p style="margin: 5px 0 0 0; font-weight: bold;">Municipal Commissioner Desk, Municipal Authority &copy; 2026</p>
                </div>
            </div>
        </body>
    </html>
