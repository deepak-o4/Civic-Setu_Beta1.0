...
def test_citizen_rating_rewards():
    ...
    # Test rating mapping
    assert fm.record_citizen_rating("CS-2026-T1", 5) == 1.0
    assert fm.record_citizen_rating("CS-2026-T2", 4) == 0.5
    assert fm.record_citizen_rating("CS-2026-T3", 3) == 0.0
    assert fm.record_citizen_rating("CS-2026-T4", 2) == -1.0
    assert fm.record_citizen_rating("CS-2026-T5", 1) == -2.0
...
def test_corrupted_ledger_recovery():
    ...
    assert fm.record_citizen_rating("CS-2026-OK", 5) == 1.0
...
def test_rolling_average_rolling_20():
    ...
    # Total 30 items
    for i in range(25):
        fm.record_citizen_rating(f"CS-2026-P{i}", 5)
    for i in range(5):
        fm.record_citizen_rating(f"CS-2026-N{i}", 1)
...
def test_policy_thresholds():
    ...
    for _ in range(5):
        fm.record_citizen_rating("CS-2026-GOOD", 5) # reward +1.0
    ...
    fm._save_ledger()
    for _ in range(5):
        fm.record_citizen_rating("CS-2026-BAD", 1) # reward -2.0
...
def test_concurrent_writes():
    ...
    def write_feedback(i):
        fm.record_citizen_rating(f"CS-2026-C{i}", 5)
