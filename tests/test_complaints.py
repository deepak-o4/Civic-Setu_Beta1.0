...
async def test_create_complaint_success_and_routed(
    ...
    # Create an officer in PWD, South Zone
...
async def test_routing_head_fallback(
    ...
    data = {
        ...
        "citizen_phone": "9876543211",
        "title": "Water Leak East Zone",
        "description": "Pipe broken in East Zone",
        "district": "East Zone", # No officer here
        "category": "WATER"
    }
...
async def test_routing_low_confidence_admin_queue(
    ...
    data = {
        ...
        "title": "Unknown issue North Zone",
        "description": "I have an issue but I don't know who to tell North Zone.",
        "district": "North Zone"
