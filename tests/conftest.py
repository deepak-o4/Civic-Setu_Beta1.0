...
TEST_SQLALCHEMY_DATABASE_URL = "sqlite+aiosqlite:///./test.db" if settings.USE_SQLITE.lower() == "true" else "postgresql+asyncpg://postgres:anubhav2004@localhost:5432/civicsetu_test"
