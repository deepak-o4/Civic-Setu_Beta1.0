...
async def test_compute_snapshot_success(db_session: AsyncSession, create_test_user):
    ...
    assert snapshot["top_districts"]["South Zone"] == 1
    assert snapshot["top_districts"]["West Zone"] == 1
