...
const COLORS = ['#0B1F1B', '#22b96c', '#C6F135']; // ink for pending, teal for in progress, lime for resolved
...
const Charts = ({ complaints }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      {/* Status Pie Chart */}
      <div className="bg-white p-6 rounded-3xl border border-ink/5 shadow-card hover:shadow-soft transition-all duration-300">
        ...
        <div className="h-64">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={districtData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
              ...
              />
              <Bar dataKey="count" fill="#0B1F1B" radius={[6, 6, 6, 6]} barSize={36} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-3xl border border-ink/5 shadow-card hover:shadow-soft transition-all duration-300 lg:col-span-2">
        <h3 className="text-lg font-bold text-ink mb-6 flex items-center gap-2">
          ...
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={monthlyData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
              ...
              <Line 
                ...
                stroke="#22b96c" 
                strokeWidth={3} 
                dot={{ r: 4, strokeWidth: 2, fill: '#fff', stroke: '#22b96c' }} 
                activeDot={{ r: 6, fill: '#C6F135', stroke: 'rgba(34, 185, 108, 0.3)', strokeWidth: 8 }} 
              />
            </LineChart>
          </ResponsiveContainer>
        </div>
