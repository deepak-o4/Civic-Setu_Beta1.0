...
logger = logging.getLogger("civicsetu.routing_engine")
...
class AIRoutingAssignmentEngine:
    ...
    def evaluate_optimal_officer(self, complaint_text: str, available_officers: list[dict]) -> dict:
        ...
        system_context = (
            "You are the Core AI Officer Assignment Module for CivicSetu, the Urban Infrastructure Intelligence Platform.\n"
